...
int main(){
    ...
    cout<<"maximum continuous sum sub array using : "<<endl;
    clock_t t;
    t=clock();
    cout<<"Brute Force approach : "<<max_sum_arr(arr,x)<<endl;
    t=clock()-t;
    double tt=((double)t)/CLOCKS_PER_SEC;
    
    cout<<std::fixed<<"TIME TAKEN FOR BRUTE FORCE APPROACH IS : "<<tt<<endl;
    t=clock();
    cout<<"2 way divie and conquer approach : "<< max_sum_arr_2way(arr,0,x-1)<<endl;
        t=clock()-t;
     tt=t/CLOCKS_PER_SEC;
    cout<<std::fixed<<"TIME TAKEN FOR 2 way divie and conquer approach :  APPROACH IS : "<<tt<<endl;
    t=clock();
   cout<<"3 way divie and conquer approach : "<<max_sum_arr_3way(arr,0,x-1)<<endl;
        t=clock()-t;
     tt=t/CLOCKS_PER_SEC;
    cout<<std::fixed<<"TIME TAKEN FOR 3 way divie and conquer approach :  APPROACH IS : "<<tt<<endl;
}
